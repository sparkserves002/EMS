...
export default function EmployerDashboard() {
  ...
  const statCards = [
    { title: 'Total Employees', value: stats.employees, icon: '👥', color: '#2d5016' },
    ...
    <div style={{ padding: 20, maxWidth: 1400, margin: '0 auto' }}>
      ...
      <div style={styles.section}>
        ...
        <div style={styles.actionsGrid}>
          <div style={styles.actionCard} onClick={() => navigate('/employer/employees')}>
            <span style={styles.actionIcon}>👥</span>
            <span>Manage Employees</span>
          </div>
          <div style={styles.actionCard} onClick={() => navigate('/employer/leaves')}>
            <span style={styles.actionIcon}>🏖️</span>
            <span>Leave Approvals</span>
          </div>
          <div style={styles.actionCard} onClick={() => navigate('/employer/tickets')}>
            <span style={styles.actionIcon}>🎫</span>
            <span>Support Tickets</span>
          </div>
          <div style={styles.actionCard} onClick={() => navigate('/employer/payroll')}>
            <span style={styles.actionIcon}>💰</span>
            <span>Generate Payroll</span>
          </div>
          <div style={styles.actionCard} onClick={() => navigate('/employer/attendance')}>
            <span style={styles.actionIcon}>📊</span>
            <span>Attendance Records</span>
          </div>
          <div style={{...styles.actionCard, background: 'linear-gradient(135deg, #2d5016 0%, #1a3009 100%)', color: 'white'}} onClick={() => navigate('/employer/ai-assistant')}>
            <span style={styles.actionIcon}>🤖</span>
            <span>AI Assistant</span>
          </div>
          <div style={styles.actionCard} onClick={() => navigate('/employer/reports')}>
            <span style={styles.actionIcon}>📈</span>
...
const styles = {
  ...
  viewBtn: { padding: '6px 12px', background: '#2d5016', color: 'white', border: 'none', borderRadius: 4, cursor: 'pointer', fontSize: 12 },
};
